...
DealBus est une plateforme toute neuve, et nous cherchons nos premiers transporteurs partenaires. Pas de chiffres gonflés, pas de promesses en l'air : les clients, nous allons les chercher nous-mêmes. Plus de 100 000 organisateurs de déplacements en car (écoles, collèges, lycées, mairies, CCAS, intercommunalités) font partie de notre campagne de contact, partout en France. Mais sans transporteurs pour leur répondre, il n'y a pas de clients. C'est donc par vous que tout commence.
...
<tr><td style="padding:28px 30px 24px;font-family:Arial,Helvetica,sans-serif;">
  ...
  ${par(`<strong>DealBus est une plateforme toute neuve</strong>, et nous cherchons nos premiers transporteurs partenaires. Les clients, nous allons les chercher nous-mêmes : <strong>plus de 100 000 organisateurs de déplacements en car</strong> (écoles, collèges, lycées, mairies, CCAS, intercommunalités) font partie de notre campagne de contact, partout en France. Mais sans transporteurs pour leur répondre, il n'y a pas de clients. C'est par vous que tout commence.`)}
...
Depuis, les inscriptions de transporteurs avancent, et notre campagne clients est lancée : plus de 100 000 organisateurs de déplacements en car (écoles, mairies, CCAS, intercommunalités) sont en cours de contact partout en France. Le principe reste inchangé : les premiers inscrits de chaque département recevront les premières demandes de leur zone. Cette place se prend en 2 minutes, sans abonnement ni engagement, commission uniquement sur les missions gagnées.
...
<tr><td style="padding:28px 30px 24px;font-family:Arial,Helvetica,sans-serif;">
  ...
  ${par(`Depuis, les inscriptions de transporteurs avancent, et notre campagne clients est lancée : <strong>plus de 100 000 organisateurs de déplacements en car</strong> (écoles, mairies, CCAS, intercommunalités) sont en cours de contact partout en France. Le principe reste inchangé : <strong>les premiers inscrits de chaque département recevront les premières demandes de leur zone</strong>. Cette place se prend en 2 minutes, sans abonnement ni engagement, commission uniquement sur les missions gagnées.`)}
