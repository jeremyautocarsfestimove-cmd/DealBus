...
export const REGIONS: Region[] = [
  {
    ...
    saison: "La demande explose de mai à juillet — sorties scolaires de fin d'année, kermesses et mariages saturent les plannings des samedis. Creux relatif en janvier et février, où les prix descendent nettement. Les arbres de Noël de CSE créent un second pic sur les trois premières semaines de décembre.",
  ...
  },
  {
    ...
    saison: "Avril à octobre concentre l'essentiel de l'activité : circuits mémoriels, croisiéristes du Havre et sorties de plein air. Les autocaristes normands, en revanche, restent disponibles et compétitifs de novembre à mars, période idéale pour les sorties d'entreprise et les compétitions.",
  ...
  },
  {
    ...
    saison: "La saison des châteaux court de mars à novembre et culmine en mai-juin avec les classes de découverte. Les pèlerinages de Chartres marquent le printemps. L'hiver reste calme, ce qui en fait la meilleure fenêtre tarifaire de l'année.",
  ...
  },
  {
    ...
    saison: "Les liaisons transmanche et les transferts depuis Beauvais tournent toute l'année, avec un pic estival. Le Parc Astérix rythme la saison d'avril à début novembre. Décembre est marqué par les marchés de Noël vers la Belgique et l'Allemagne.",
  ...
  },
  {
    ...
    saison: "La saisonnalité est la plus marquée de France : de décembre à avril, les rotations neige mobilisent des flottes entières le samedi, et les prix suivent. Hors saison de ski, la région redevient très abordable pour les congrès et les sorties scolaires.",
  ...
  },
  {
    ...
    saison: "De mai à septembre, congrès cannois, escales de croisière et colonies tirent la demande vers le haut. Les mois de février et mars, hors vacances, offrent des tarifs sensiblement plus bas pour les mêmes prestations.",
  ...
  },
{
    ...
    saison: "Juin à septembre est la haute saison, portée par les colonies, les festivals et le tourisme côtier. Le reste de l'année, les autocaristes bretons vivent des scolaires et des clubs sportifs, avec de bonnes disponibilités en semaine.",
  ...
  },
  {
    ...
    saison: "Le Puy du Fou structure la saison d'avril à septembre, avec les 24 Heures du Mans en juin comme point culminant. Les mois creux de janvier à mars sont les plus intéressants pour les groupes flexibles sur les dates.",
  ...
  },
  {
    ...
    saison: "La côte atlantique et le Bassin d'Arcachon saturent en juillet-août. Les pèlerinages de Lourdes s'étalent d'avril à octobre. La demande retombe fortement en novembre et janvier, période où la mise en concurrence produit les meilleurs écarts.",
  ...
  },
  {
    ...
    saison: "Trois saisons se superposent : congrès toulousains à l'automne et au printemps, balnéaire l'été, stations pyrénéennes l'hiver. Résultat, peu de véritables mois creux — publier tôt fait ici une vraie différence sur le prix.",
  ...
  },
  {
    ...
    saison: "Le pic de fin d'année est unique en France : les marchés de Noël mobilisent les cars de fin novembre à début janvier, avec des plannings bouclés dès septembre. Les circuits champagne et la route des Vins prennent le relais d'avril à octobre.",
  ...
  },
  {
    ...
    saison: "L'œnotourisme concentre la demande de mai à octobre, avec un pic aux vendanges en septembre. Le reste de l'année, la position sur l'axe Paris ↔ Lyon garantit une offre abondante et des tarifs contenus.",
  ...
  },
  {
    ...
    saison: "Tout se joue d'avril à octobre, au rythme des ferries et des escales de croisière. Le parc insulaire étant limité, réserver tôt n'est pas un conseil mais une nécessité en juillet-août — hors saison, les tarifs chutent nettement.",
...
export function regionParNom(nom: string): Region | undefined {
  return REGIONS.find((r) => r.nom === nom);
}
